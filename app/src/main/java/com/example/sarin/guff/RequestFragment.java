...
public class RequestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        friendRequest_database.keepSynced(true);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.exists()) {
                            ...
                            if(requestType.equals("received")) {
                                ...
                                acceptRequestButton.setTextColor(Color.parseColor("#ffffff"));
                                ...
                                cancelFriendRequestButton.setTextColor(Color.parseColor("#ffffff"));
                                cancelFriendRequestButton.setPadding(10,0,10,0);
