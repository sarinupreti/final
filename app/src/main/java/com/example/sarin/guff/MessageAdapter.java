    ...
    public MessageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case 6:
                ...
                break;
//            case 7:
//                v = LayoutInflater.from(parent.getContext()).inflate(R.layout.location_me, parent, false);
//                break;
//            case 8:
//                v = LayoutInflater.from(parent.getContext()).inflate(R.layout.location_others, parent, false);
//                break;
